...
# print(f"The root mean square error for Decision Tree Regression is {dec_rmse}")
...
# print(f"The root mean square error for Random Forest Regression is {random_forest_rmse}")
